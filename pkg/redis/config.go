...
func (c *Config) Equal(other *Config) bool {
	...
	return utl.Equal(c.Network, other.Network) &&
		...
		utl.Equal(c.PoolFIFO, other.PoolFIFO) &&
		...
		utl.Equal(c.IdleTimeout, other.IdleTimeout) &&
		utl.Equal(c.IdleCheckFrequency, other.IdleCheckFrequency)
}
