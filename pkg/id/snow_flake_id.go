...
// NewSnowFlakeId dataCenterId :机房ID ，workerId：机器ID
func NewSnowFlakeId(dataCenterId int64, workerId int64) *SnowFlakeId {
	ret := &SnowFlakeId{}
	ret.init(dataCenterId, workerId)
	return ret
}

// init 初始化
func (p *SnowFlakeId) init(dataCenterId int64, workerId int64) {
	// 开始时间戳；这里是2021-06-01
...
func (p *SnowFlakeId) tilNextMillis(lastTimestamp int64) int64 {
	timestamp := p.timeGen()
...
func (p *SnowFlakeId) timeGen() int64 {
